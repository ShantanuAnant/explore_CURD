"""
Django settings for exploreapi project.
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # Make sure that this stays above common middleware
...
WSGI_APPLICATION = 'exploreapi.wsgi.application'
